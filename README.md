...
### Step 3. Install nodejs server [fit_server](https://github.com/thenaim/fit_server)
1. Make sure you're using nodejs v10.20.1 or later
...
Set your IPv4, port and auth token (from [Step 4](https://github.com/thenaim/fit_app#step-4-run-nodejs-server)) on js/app.js. In line 6 and 12.
